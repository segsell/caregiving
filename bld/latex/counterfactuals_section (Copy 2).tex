...
\begin{table}[htbp]
  ...
  \begin{tabular}{lrrr}
    ...
    \quad FT rate (30--67) & --- & --- & $-1.89$ pp \\
    \quad PT rate (30--67) & --- & --- & $-0.59$ pp \\
    \quad Unemployment rate (30--67) & --- & --- & $+1.91$ pp \\
    \addlinespace
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lrrrrr}
    ...
    \addlinespace
    All (40--67) & 41,155 & 39.7\% & 36.1\% & 24.2\% & -- \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lrrrr}
    ...
    \addlinespace
    General population & 68.6\% & 36.6\% & 23.1\% & -- \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lrrrr}
    ...
    Leave top-up (gross) & -- & 2,695 & 28,938 & -- \\
