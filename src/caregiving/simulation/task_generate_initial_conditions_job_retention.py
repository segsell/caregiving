...
# @pytask.mark.initial_states_job_retention
...
#     # Partner state
#     partner_states = np.empty(n_agents, dtype=np.uint8)
...
#     exp_agents = np.empty(n_agents, dtype=np.float64)
#     lagged_choice = np.empty(n_agents, dtype=np.uint8)
