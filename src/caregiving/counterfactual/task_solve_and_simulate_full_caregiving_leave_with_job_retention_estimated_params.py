"""Solve and simulate the full caregiving-leave-with-job-retention counterfactual."""
...
# @pytask.mark.sim_estimated_params_full_caregiving_leave_with_job_retention
def solve_and_simulate_full_caregiving_leave_with_job_retention_estimated_params(
    ...
    / "solve_and_simulate"
    / "solution_full_caregiving_leave_with_job_retention_estimated_params.pkl",
