"""Age-based plotting functions for caregiving leave vs baseline counterfactual."""
...
def task_plot_matched_differences_by_age_caregiving_leave_vs_baseline(  # noqa: PLR0912, PLR0915
    # noqa: E501
    ...
    """Compute matched period differences (caregiving leave - baseline) by age.
