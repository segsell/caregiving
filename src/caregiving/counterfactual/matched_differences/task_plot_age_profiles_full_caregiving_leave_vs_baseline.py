"""Age-based plotting functions for full caregiving leave vs baseline counterfactual."""
...
def task_plot_matched_differences_by_age_full_caregiving_leave_vs_baseline(  # noqa: PLR0915, E501
    ...
    """Compute matched period differences (full caregiving leave - baseline) by age.
    ...
    df_o, df_c = prepare_dataframes_for_comparison(
        pd.read_pickle(path_to_full_caregiving_leave_data),
