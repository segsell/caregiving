"""Plot differences in labor supply for full caregiving leave vs baseline  # noqa: E501
counterfactual.

Full caregiving leave with job retention and baseline scenario.
"""
...
def task_plot_matched_differences_by_distance(  # noqa: PLR0915, E501
    ...
    """Compute matched period differences (full caregiving leave - baseline).
    ...
    Steps:
      ...
      5) Compute distance_to_first_care from full caregiving leave, attach to merged.
    ...
    # Compute distance in full caregiving leave and attach
...
def _process_data_for_age_at_first_care(
    ...
    Args:
        path_to_caregiving_leave_data: Path to full caregiving leave data
...
def task_plot_matched_differences_gross_labor_income_by_age_at_first_care(
    ...
    """Compute matched period differences for gross labor income by age at  # noqa: E501
    first care."""
    if ages_at_first_care is None:
        ages_at_first_care = [45, 50, 54, 58, 62]
...
def task_plot_matched_differences_pt_by_age_bins_at_first_care(
    ...
    """Compute matched period differences for part-time work by age bins  # noqa: E501
    at first care."""
...
def task_plot_matched_differences_ft_by_age_bins_at_first_care(
    ...
    """Compute matched period differences for full-time work by age bins  # noqa: E501
    at first care."""
    # Get merged dataframe and unique bins from helper
    merged, unique_bins = _process_data_for_age_bins_at_first_care(
        path_to_caregiving_leave_data=path_to_caregiving_leave_data,
...
def task_plot_matched_differences_work_by_age_bins_at_first_care(
    ...
    """Compute matched period differences for employment rate by age bins  # noqa: E501
    at first care."""
    # Get merged dataframe and unique bins from helper
    merged, unique_bins = _process_data_for_age_bins_at_first_care(
        path_to_caregiving_leave_data=path_to_caregiving_leave_data,
...
def task_plot_matched_differences_hours_weekly_by_age_bins_at_first_care(
    ...
    """Compute matched period differences for working hours by age bins at  # noqa: E501
    first care."""
    # Get merged dataframe and unique bins from helper
    merged, unique_bins = _process_data_for_age_bins_at_first_care(
        path_to_caregiving_leave_data=path_to_caregiving_leave_data,
...
def task_plot_matched_differences_gross_labor_income_by_age_bins_at_first_care(
    ...
    """Compute matched period differences for gross labor income by age  # noqa: E501
    bins at first care."""
    # Get merged dataframe and unique bins from helper
    merged, unique_bins = _process_data_for_age_bins_at_first_care(
        path_to_caregiving_leave_data=path_to_caregiving_leave_data,
...
def task_plot_first_care_start_by_age(
    ...
    Args:
        path_to_caregiving_leave_data: Path to full caregiving leave simulated data
...
def task_plot_matched_differences_by_distance_by_care_demand(  # noqa: PLR0915, E501
    ...
    Steps:
      ...
      4) Merge on (agent, period) and compute differences.
      5) Compute distance_to_first_care_demand from full caregiving leave,
          attach to merged.
...
def task_plot_matched_differences_job_offer_by_age_bins_at_first_care_demand(
    ...
    """Compute matched period differences for job offer by age bins at  # noqa: E501
    first care demand."""
    # Get merged dataframe and unique bins from helper
    merged, unique_bins = _process_data_for_age_bins_at_first_care_demand(
        path_to_caregiving_leave_data=path_to_caregiving_leave_data,
...
def task_plot_matched_differences_savings_by_age_bins_at_first_care_demand(
    ...
    """Compute matched period differences for savings by age bins at first  # noqa: E501
    care demand."""
    # Get merged dataframe and unique bins from helper
    merged, unique_bins = _process_data_for_age_bins_at_first_care_demand(
        path_to_caregiving_leave_data=path_to_caregiving_leave_data,
...
def task_plot_matched_differences_wealth_by_age_bins_at_first_care_demand(
    ...
    """Compute matched period differences for wealth by age bins at first  # noqa: E501
    care demand."""
    # Get merged dataframe and unique bins from helper
    merged, unique_bins = _process_data_for_age_bins_at_first_care_demand(
        path_to_caregiving_leave_data=path_to_caregiving_leave_data,
...
def task_plot_matched_differences_savings_rate_by_age_bins_at_first_care_demand(
    ...
    """Compute matched period differences for savings rate by age bins at  # noqa: E501
    first care demand."""
    # Get merged dataframe and unique bins from helper
    merged, unique_bins = _process_data_for_age_bins_at_first_care_demand(
        path_to_caregiving_leave_data=path_to_caregiving_leave_data,
...
def task_plot_matched_differences_forced_care_demand_at_50(  # noqa: PLR0915, E501
    ...
    # Create outcome columns (include age from full caregiving leave)
    o_cols = create_outcome_columns(df_cg, cg_outcomes, "_o")
    c_cols = create_outcome_columns(df_baseline, baseline_outcomes, "_c")
