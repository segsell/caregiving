"""Solve and simulate the full Beirat caregiving leave counterfactual (max 1 year full leave)."""
...
from caregiving.model.task_specify_model_caregiving_leave_full_beirat import (
...
def solve_and_simulate_caregiving_leave_full_beirat_estimated_params(
    path_to_specs: Path = BLD / "model" / "specs" / "specs_full.pkl",
    path_to_model: Path = BLD / "model" / "model_caregiving_leave_full_beirat.pkl",
    ...
    path_to_initial_states: Path = (
        BLD / "model" / "initial_conditions" / "initial_states_full_beirat.pkl"
    ),
    path_to_save_solution: Annotated[Path, Product] = BLD
    / "solve_and_simulate"
    / "solution_caregiving_leave_full_beirat_estimated_params.pkl",
    path_to_save_simulated_data: Annotated[Path, Product] = BLD
    / "solve_and_simulate"
    / "simulated_data_caregiving_leave_full_beirat_estimated_params.pkl",
) -> None:
    """Solve and simulate the full Beirat caregiving leave counterfactual model."""
