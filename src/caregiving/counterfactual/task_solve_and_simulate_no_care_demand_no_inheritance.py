...
def task_solve_and_simulate_no_care_demand_no_inheritance(
    path_to_specs: Path = BLD / "model" / "specs" / "specs_full.pkl",
    path_to_model: Path = BLD / "model" / "model_no_care_demand_no_inheritance.pkl",
    ...
    / "solve_and_simulate"
    / "solution_no_care_demand_no_inheritance.pkl",
