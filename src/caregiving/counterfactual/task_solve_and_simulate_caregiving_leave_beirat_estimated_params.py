"""Solve and simulate the Beirat caregiving leave counterfactual."""
...
from caregiving.model.task_specify_model_caregiving_leave_beirat import (
...
from caregiving.model.wealth_and_budget.budget_equation_caregiving_leave_beirat import (
    budget_constraint,
)
...
def solve_and_simulate_caregiving_leave_beirat_estimated_params(
    path_to_specs: Path = BLD / "model" / "specs" / "specs_full.pkl",
    path_to_model: Path = BLD / "model" / "model_caregiving_leave_beirat.pkl",
    ...
    path_to_initial_states: Path = (
        BLD / "model" / "initial_conditions" / "initial_states_beirat.pkl"
    ),
    path_to_save_solution: Annotated[Path, Product] = BLD
    / "solve_and_simulate"
    / "solution_caregiving_leave_beirat_estimated_params.pkl",
    path_to_save_simulated_data: Annotated[Path, Product] = BLD
    / "solve_and_simulate"
    / "simulated_data_caregiving_leave_beirat_estimated_params.pkl",
) -> None:
    """Solve and simulate the Beirat caregiving leave counterfactual model."""
