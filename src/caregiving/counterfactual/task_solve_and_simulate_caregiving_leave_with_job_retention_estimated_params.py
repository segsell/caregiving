"""Solve and simulate the caregiving-leave-with-job-retention counterfactual."""
...
from caregiving.model.task_specify_model_caregiving_leave_with_job_retention import (
...
# @pytask.mark.sim_estimated_params_caregiving_leave_with_job_retention
# def task_solve_and_simulate_caregiving_leave_with_job_retention_estimated_params(
...
#         BLD / "model" / "initial_conditions" / "initial_states_job_retention.pkl"
#     ),
#     path_to_save_solution: Annotated[Path, Product] = BLD
#     / "solve_and_simulate"
#     / "solution_caregiving_leave_with_job_retention_estimated_params.pkl",
