...
def task_plot_matched_differences_by_age_cg_leave_vs_baseline(  # noqa: PLR0915, E501
    ...
    """Plot matched differences by age (full-cg-leave vs baseline)."""
    ...
    if "age" in df_full_cg.columns:
        full_cg_cols["age"] = df_full_cg["age"].values

    # Add caregiving_type and education from full_cg dataframe for filtering
    ...
    merged = merge_and_compute_differences(full_cg_cols, baseline_cols, outcome_names)
