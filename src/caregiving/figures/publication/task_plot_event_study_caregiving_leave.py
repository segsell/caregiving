...
for age_min_val, age_max_val, age_label_val in AGE_GROUPS_EVENT_STUDY:
    ...
    def task_plot_event_study_employment_by_distance_to_first_care_demand_caregiving_leave(  # noqa: E501
        ...
        """Event study: employment rate diff (baseline − caregiving leave) by distance to first care demand."""
...
for age_min_val, age_max_val, age_label_val in AGE_GROUPS_EVENT_STUDY:
    ...
    def task_plot_event_study_employment_by_distance_to_first_caregiving_spell_caregiving_leave(  # noqa: E501
        ...
        """Event study: employment rate diff (baseline − caregiving leave) by distance to first caregiving spell."""
        with path_to_specs.open("rb") as f:
            specs = pickle.load(f)
        start_age = int(specs["start_age"])
        end_age_caregiving = int(specs["end_age_caregiving"])
...
for age_min_val, age_max_val, age_label_val in AGE_GROUPS_EVENT_STUDY:
    ...
    def task_plot_event_study_full_time_by_distance_to_first_care_demand_caregiving_leave(  # noqa: E501
        ...
        """Event study: full-time rate diff (baseline − caregiving leave) by distance to first care demand."""
        with path_to_specs.open("rb") as f:
            specs = pickle.load(f)
        start_age = int(specs["start_age"])
        end_age_caregiving = int(specs["end_age_caregiving"])
...
for age_min_val, age_max_val, age_label_val in AGE_GROUPS_EVENT_STUDY:
    ...
    def task_plot_event_study_full_time_by_distance_to_first_caregiving_spell_caregiving_leave(  # noqa: E501
        ...
        """Event study: full-time rate diff (baseline − caregiving leave) by distance to first caregiving spell."""
        with path_to_specs.open("rb") as f:
            specs = pickle.load(f)
        start_age = int(specs["start_age"])
        end_age_caregiving = int(specs["end_age_caregiving"])
...
for age_min_val, age_max_val, age_label_val in AGE_GROUPS_EVENT_STUDY:
    ...
    def task_plot_event_study_part_time_by_distance_to_first_care_demand_caregiving_leave(  # noqa: E501
        ...
        """Event study: part-time rate diff (baseline − caregiving leave) by distance to first care demand."""
        with path_to_specs.open("rb") as f:
            specs = pickle.load(f)
        start_age = int(specs["start_age"])
        end_age_caregiving = int(specs["end_age_caregiving"])
...
for age_min_val, age_max_val, age_label_val in AGE_GROUPS_EVENT_STUDY:
    ...
    def task_plot_event_study_part_time_by_distance_to_first_caregiving_spell_caregiving_leave(  # noqa: E501
        ...
        """Event study: part-time rate diff (baseline − caregiving leave) by distance to first caregiving spell."""
        with path_to_specs.open("rb") as f:
            specs = pickle.load(f)
        start_age = int(specs["start_age"])
        end_age_caregiving = int(specs["end_age_caregiving"])
...
for age_min_val, age_max_val, age_label_val in AGE_GROUPS_EVENT_STUDY:
    ...
    def task_plot_event_study_working_hours_by_distance_to_first_care_demand_caregiving_leave(  # noqa: E501
        ...
        """Event study: weekly working hours diff (baseline − caregiving leave) by distance to first care demand."""
        with path_to_specs.open("rb") as f:
            specs = pickle.load(f)
        start_age = int(specs["start_age"])
        end_age_caregiving = int(specs["end_age_caregiving"])
...
for age_min_val, age_max_val, age_label_val in AGE_GROUPS_EVENT_STUDY:
    ...
    def task_plot_event_study_working_hours_by_distance_to_first_caregiving_spell_caregiving_leave(  # noqa: E501
        ...
        """Event study: weekly working hours diff (baseline − caregiving leave) by distance to first caregiving spell."""
        with path_to_specs.open("rb") as f:
            specs = pickle.load(f)
        start_age = int(specs["start_age"])
        end_age_caregiving = int(specs["end_age_caregiving"])
...
for age_min_val, age_max_val, age_label_val in AGE_GROUPS_EVENT_STUDY:
    ...
    def task_plot_event_study_labor_income_by_distance_to_first_care_demand_caregiving_leave(  # noqa: E501
        ...
        """Event study: monthly gross labor income diff (baseline − caregiving leave) by distance to first care demand."""
        with path_to_specs.open("rb") as f:
            specs = pickle.load(f)
        start_age = int(specs["start_age"])
        end_age_caregiving = int(specs["end_age_caregiving"])
...
for age_min_val, age_max_val, age_label_val in AGE_GROUPS_EVENT_STUDY:
    ...
    def task_plot_event_study_labor_income_by_distance_to_first_caregiving_spell_caregiving_leave(  # noqa: E501
        ...
        """Event study: monthly gross labor income diff (baseline − caregiving leave) by distance to first caregiving spell."""
        with path_to_specs.open("rb") as f:
            specs = pickle.load(f)
        start_age = int(specs["start_age"])
        end_age_caregiving = int(specs["end_age_caregiving"])
...
for age_min_val, age_max_val, age_label_val in AGE_GROUPS_EVENT_STUDY:
    ...
    def task_plot_event_study_job_finding_by_distance_to_first_care_demand_caregiving_leave(  # noqa: E501
        ...
        """Event study: job finding rate diff (baseline − caregiving leave) by distance to first care demand."""
        with path_to_specs.open("rb") as f:
            specs = pickle.load(f)
        start_age = int(specs["start_age"])
        end_age_caregiving = int(specs["end_age_caregiving"])
...
for age_min_val, age_max_val, age_label_val in AGE_GROUPS_EVENT_STUDY:
    ...
    def task_plot_event_study_job_finding_by_distance_to_first_caregiving_spell_caregiving_leave(  # noqa: E501
        ...
        """Event study: job finding rate diff (baseline − caregiving leave) by distance to first caregiving spell."""
        with path_to_specs.open("rb") as f:
            specs = pickle.load(f)
        start_age = int(specs["start_age"])
        end_age_caregiving = int(specs["end_age_caregiving"])
...
for age_min_val, age_max_val, age_label_val in AGE_GROUPS_EVENT_STUDY:
    ...
    def task_plot_event_study_job_retention_by_distance_to_first_care_demand_caregiving_leave(  # noqa: E501
        ...
        """Event study: job retention rate diff (baseline − caregiving leave) by distance to first care demand."""
        with path_to_specs.open("rb") as f:
            specs = pickle.load(f)
        start_age = int(specs["start_age"])
        end_age_caregiving = int(specs["end_age_caregiving"])
...
for age_min_val, age_max_val, age_label_val in AGE_GROUPS_EVENT_STUDY:
    ...
    def task_plot_event_study_job_retention_by_distance_to_first_caregiving_spell_caregiving_leave(  # noqa: E501
        ...
        """Event study: job retention rate diff (baseline − caregiving leave) by distance to first caregiving spell."""
        with path_to_specs.open("rb") as f:
            specs = pickle.load(f)
        start_age = int(specs["start_age"])
        end_age_caregiving = int(specs["end_age_caregiving"])
