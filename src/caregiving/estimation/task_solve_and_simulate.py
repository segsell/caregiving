...
def task_solve_and_simulate_start_params(
    path_to_model: Path = BLD / "model" / "model_baseline.pkl",
    ...
    model = pickle.load(path_to_model.open("rb"))
    ...
    sim_df = model.solve_and_simulate(
        params,
        states_initial=initial_states,
        wealth_initial=wealth_agents,
        save_sol_path=path_to_save_solution,
    )
    breakpoint()
