...
def task_solve_and_simulate_start_params(
    ...
    path_to_save_solution_value: Annotated[Path, Product] = BLD
    / "solve_and_simulate"
    / "solution_value.npy",
    path_to_save_solution_policy: Annotated[Path, Product] = BLD
    / "solve_and_simulate"
    / "solution_policy.npy",
    path_to_save_solution_endog_grid: Annotated[Path, Product] = BLD
    / "solve_and_simulate"
    / "solution_endog_grid.npy",
    ...
    # --- 1) Solve (keep JAX arrays in memory) ---
    value, policy, endog_grid = get_solve_func_for_model(model_for_solution)(params)

    # np.save(path_to_save_solution_value, value)
    # np.save(path_to_save_solution_policy, policy)
    # np.save(path_to_save_solution_endog_grid, endog_grid)
    ...
    sim_df = simulate_scenario(
        ...
        solution_endog_grid=endog_grid,
