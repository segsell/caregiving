"""Plot inheritance by age from simulated caregiving leave counterfactual model data.
...
def task_plot_inheritance_by_age_caregiving_leave(  # noqa: PLR0912, PLR0915
    ...
    / "plots"
    / "post_estimation"
    / "inheritance_share_by_age_caregiving_leave.png",
    path_to_save_share_lagged_plot: Annotated[Path, Product] = BLD
    / "plots"
    / "post_estimation"
    / "inheritance_share_by_age_lagged_mother_dead_caregiving_leave.png",
    path_to_save_mother_dead_share_plot: Annotated[Path, Product] = BLD
    / "plots"
    / "post_estimation"
    / "mother_recently_dead_share_by_age_caregiving_leave.png",
    path_to_save_amount_plot: Annotated[Path, Product] = BLD
    / "plots"
    / "post_estimation"
    / "inheritance_amount_by_age_caregiving_leave.png",
    path_to_save_amount_unconditional_plot: Annotated[Path, Product] = BLD
    / "plots"
    / "post_estimation"
    / "inheritance_amount_by_age_unconditional_caregiving_leave.png",
    path_to_save_amount_no_inheritance_plot: Annotated[Path, Product] = BLD
    / "plots"
    / "post_estimation"
    / "inheritance_amount_by_age_no_inheritance_caregiving_leave.png",
    path_to_save_amount_positive_plot: Annotated[Path, Product] = BLD
    / "plots"
    / "post_estimation"
    / "inheritance_amount_by_age_positive_caregiving_leave.png",
    path_to_save_amount_check1_plot: Annotated[Path, Product] = BLD
    / "plots"
    / "post_estimation"
    / "inheritance_amount_by_age_check1_caregiving_leave.png",
    path_to_save_amount_check2_plot: Annotated[Path, Product] = BLD
    / "plots"
    / "post_estimation"
    / "inheritance_amount_by_age_check2_caregiving_leave.png",
):
    """Plot inheritance share and amount by age from caregiving leave  # noqa: E501
    ...
    ax.set_title(
        (
            ...
            "and Care Type (Caregiving Leave)\n"
    ...
    ax.set_title(
        "Share with Mother Recently Dead by Age and Education (Caregiving Leave)",
        fontsize=13,
    )
    ax.grid(True, alpha=0.3)
    ...
    ax.set_title(
        "Average Inheritance Amount by Age and Education (Caregiving Leave)\n"
