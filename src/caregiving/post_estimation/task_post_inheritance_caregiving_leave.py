...
def task_plot_inheritance_by_age_caregiving_leave(  # noqa: PLR0915
    ...
    """Plot inheritance share and amount by age from caregiving leave counterfactual simulated data.

    Creates nine plots with 6 lines each (2 education × 3 care types) for plots 1-2, 4, 6-7, 9:
    ...
    ax.set_title(
        "Inheritance Receipt Probability by Age, Education, and Care Type (Caregiving Leave)\n"
    ...
    if len(df_positive) > 0:
        ...
        ax.set_title(
            "Average Inheritance Amount by Age, Education, and Care Type (Caregiving Leave)\n"
    ...
    # Whole sample, filtered to positive bequest AND mother NOT recently dead, grouped by education and care type
    ...
    # Whole sample, filtered to positive bequest AND gets_inheritance == 0, grouped by education and care type
    # This should be 0 or very small (sanity check)
    # =================================================================================
