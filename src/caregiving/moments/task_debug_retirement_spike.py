...
def debug_retirement_spike(
    ...
    if results_df is not None and len(results_df) > 0:
        ...
        ratio_scales = (
            results_df["max_pp_retirement"].mean()
            / results_df["max_exp_working"].mean()
        )
        ...
        if mean_ratio > 1.1:
            ...
            print(
                "  The issue: Experience normalized value is being rescaled with retirement"
            )
