...
def create_state_space_functions():
    return {
        ...
        "next_period_endogenous_state": (
            next_period_endogenous_state_with_job_retention
        ),
...
def sparsity_condition_with_job_retention(  # noqa: PLR0911, PLR0912
    ...
    # ================================================================================
        ...
        return False
    # elif (age > options["end_age_msm"] + 1) & (job_before_caregiving != 0):
    #     return False
    # ================================================================================
...
def apply_retirement_constraint_for_SRA(SRA, options):
    return jnp.maximum(SRA - options["ret_years_before_SRA"], 63)
...
def get_next_period_experience(
    ...
    exp_update = (
        is_full_time(lagged_choice)
        + is_part_time(lagged_choice)
        * options["exp_increase_part_time"]
        * (1 - informal_care)
