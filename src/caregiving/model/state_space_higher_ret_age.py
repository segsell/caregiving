# """State space with higher retirement ages (min_SRA=69, max_ret_age=72).

# This module mirrors the original state space implementation but enforces
# higher retirement ages internally. Use together with
# `task_specify_model_higher_ret_age`, which sets `min_SRA=69` and
# `max_ret_age=72` in the options.
# """
...
#                 "mother_health": PARENT_LONGER_DEAD,
#                 "care_demand": 0,
#                 "job_offer": 0,
#             }
#             return state_proxy
#         elif mother_health == PARENT_LONGER_DEAD:
