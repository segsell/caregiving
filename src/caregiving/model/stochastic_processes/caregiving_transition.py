...
#     Combines death transition and care demand transition into a single
# 4-state process:
...
#     # Note: mother_adl == 0 (dead) is handled above, so we subtract 1 to map
# [1,2,3] -> [0,1,2]
...
#     # State 3: CARE_DEMAND_INTENSIVE (mother is alive, ADL 2 or 3, in
#     # caregiving window)
