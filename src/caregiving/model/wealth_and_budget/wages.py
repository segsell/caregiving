...
def hourly_wage_equation(gamma_0, gamma_ln_exp, income_shock, experience_years):
    ...
    ln_exp = jnp.log(experience_years + 1)
    wage = jnp.exp(gamma_0 + gamma_ln_exp * ln_exp + income_shock)
