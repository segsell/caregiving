"""Government budget calculations for tax revenue and expenditures."""
...
def calc_government_budget_components(
    ...
    government_expenditures : float
        Total government expenditures (benefits)
    ...
    government_expenditures = (
        child_benefits + care_benefits + household_unemployment_benefits
    )
