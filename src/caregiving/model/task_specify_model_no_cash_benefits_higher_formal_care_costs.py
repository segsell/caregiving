# """Specify model for higher formal care costs without cash benefits counterfactual."""
...
# from caregiving.model.wealth_and_budget.budget_equation_no_cash_benefits import (  # noqa: E501
#     budget_constraint,
# )
...
# @pytask.mark.skip()
# @pytask.mark.no_cash_benefits_higher_formal_care_costs
# def task_specify_model_no_cash_benefits_higher_formal_care_costs(
...
#     / "model"
#     / "options_no_cash_benefits_higher_formal_care_costs.pkl",
...
#     / "model"
#     / "params"
#     / "start_params_model_no_cash_benefits_higher_formal_care_costs.yaml",
# ):
#     """Generate model and options for higher formal care costs without cash benefits.

#     This counterfactual mirrors the higher-formal-care-costs scenario, but is intended
#     to be combined with a policy where cash benefits are turned off in the budget
#     equation.
#     """
...
#     print("No-cash-benefits higher formal care costs counterfactual model specified.")
#     return model, params
