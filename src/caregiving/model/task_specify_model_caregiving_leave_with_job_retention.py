"""Specify model for leave-with-job-retention counterfactual."""
...
def specify_model_caregiving_leave_with_job_retention(
    ...
    """Generate model for leave-with-job-retention counterfactual.
    ...
    print("Leave-with-job-retention counterfactual model specified.", flush=True)

    return model


def create_stochastic_states_transitions():
    """Stochastic state transitions for job retention counterfactual.
