...
#     # Assign income shock scale and core parameters to start_params_all
...
#                 "job_before_caregiving": np.arange(3, dtype=int),
#             },
#             "exogenous_processes": {
#                 "job_offer": {
...
#     print("Leave-with-job-retention counterfactual model specified.")
#     return model, params
