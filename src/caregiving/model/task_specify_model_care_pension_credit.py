"""Specify model with care pension credit for unemployed intensive caregivers.

Identical to the baseline model except that unemployed agents providing intensive
informal care receive +0.5 pension-point credit per period (capped at 1.0).
"""
...
def specify_model(
    path_to_derived_specs,
    path_to_save_model_config,
    path_to_save_model,
):
